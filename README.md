...
Example:
```shell
java -jar ./GARN2.jar PDBTOGARN 1E8O 1E8O_fasta.txt 1E8O.pdb
```
...
Example:
```shell
java -jar ./GARN2.jar GAME 1E8O 1E8O_fasta.txt 10
```

Output 10 files : GARN_‹Name of molecule›_0.csv, GARN_‹Name of molecule›_1.csv, ..., GARN_‹Name of molecule›_9.csv

If you wish to use an specific scoring algorithm for the molecule, please set the option EXP3 or UCB like this:
```shell
java -jar ./GARN2.jar GAME 1E8O 1E8O_fasta.txt 10 UCB
```

If you wish to compute the sampling space and also compute RMSD, you need to specify the GARN model file:

```shell
java -jar ./GARN2.jar GAME 1E8O 1E8O_fasta.txt 10 0 1E8O_GARN.csv
```
...
Output 11 files : GARN_‹Name of molecule›_0.csv, .. , & GARN_‹Name of molecule›_9.csv, ... and a ‹Name of molecule›_out.csv with the RMSD and the Maximum distance (to sort the sampling).

## Calculate RMSD between predicted molecules

To compute the RMSD between GARN files (compare to one file): `java -jar ./GARN2.jar GAME ‹Name of molecule› ‹Fasta File› ‹Number of solutions› ‹GARN file of native structure›`

Example:

```shell
java -jar ./GARN2.jar RMSD 1E8O 1E8O_GARN.csv GARN_1E8O_1.csv GARN_1E8O_2.csv GARN_1E8O_3.csv GARN_1E8O_4.csv
```
...
Example:
```shell
java -jar ./GARN2.jar SORT GARN_1E8O_1.csv GARN_1E8O_2.csv GARN_1E8O_3.csv GARN_1E8O_4.csv
```
